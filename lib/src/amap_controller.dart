...
class AMapController {
  ...
  void _connectStreams(int mapId) {
    _methodChannel
        ...
        .listen((LocationChangedEvent e) => _mapState.widget.onLocationChanged?.call(e.value));
  ...
  Future<void> updateMapOptionsX(Map<String, dynamic> optionsUpdate) {
    return _methodChannel.updateMapOptions(optionsUpdate, mapId: mapId);
  }

  Future<void> updateMarkersX(MarkerUpdates markerUpdates) {
    return _methodChannel.updateMarkers(markerUpdates, mapId: mapId);
  }

  Future<void> updatePolylinesX(PolylineUpdates polylineUpdates) {
    return _methodChannel.updatePolylines(polylineUpdates, mapId: mapId);
  }

  Future<void> updatePolygonsX(PolygonUpdates polygonUpdates) {
    return _methodChannel.updatePolygons(polygonUpdates, mapId: mapId);
  }
